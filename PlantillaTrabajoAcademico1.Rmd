...
Despúes de eliminar las reglas redundantes, hemos obtenido un total de `r length(NoRedundantesPos)` reglas. Ordenamos las reglas por su **lift** y miramos las 5 reglas con más lift.
